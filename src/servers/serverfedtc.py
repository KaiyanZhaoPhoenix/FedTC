...
class FedTC(Server):
    def __init__(self, args, times) -> None:
        ...
        self.beta = args.beta if hasattr(args, 'beta') else 0.1 # Default lowered to 0.1
    ...
    def fit(self):
        ...
        for cr in range(self.communication_rounds):
            ...
            reward = cos_sim - self.beta * dispersion
